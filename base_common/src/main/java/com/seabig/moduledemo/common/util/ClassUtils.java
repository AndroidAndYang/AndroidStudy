...
public class ClassUtils {
    ...
    getObjectsWithInterface(Context context, Class<T> clazz, String path)
    {
        ...
        {
            e.getStackTrace();
            Log.e(TAG, "getObjectsWithInterface commont_loading_error, " + e.getMessage());
        }
    ...
    public static List<String> getFileNameByPackageName(Context context, String packageName) throws PackageManager.NameNotFoundException, IOException
    {
        ...
        for (String path : getSourcePaths(context))
        {
            ...
            try
            {
                ...
                {
                    //NOT use new DexFile(path), because it will throw "permission commont_loading_error in /data/dalvik-cache"
            ...
            {
                Log.e(TAG, "Scan map file in dex files made commont_loading_error.", ignore);
            }
            finally
            {
                if (null != dexfile)
    ...
    private static List<String> tryLoadInstantRunDexFile(ApplicationInfo applicationInfo)
    {
        ...
        } else
        {
            ...
            {
                Log.e(TAG, "InstantRun support commont_loading_error, " + e.getMessage());
            }
        }
