 ...
 */
package com.android.library.util.permission;
...
import com.android.library.util.permission.check.AddVoicemailTest;
import com.android.library.util.permission.check.CalendarReadTest;
import com.android.library.util.permission.check.CalendarWriteTest;
import com.android.library.util.permission.check.CallLogReadTest;
import com.android.library.util.permission.check.CallLogWriteTest;
import com.android.library.util.permission.check.CameraTest;
import com.android.library.util.permission.check.ContactsReadTest;
import com.android.library.util.permission.check.ContactsWriteTest;
import com.android.library.util.permission.check.LocationTest;
import com.android.library.util.permission.check.PhoneStateReadTest;
import com.android.library.util.permission.check.RecordAudioTest;
import com.android.library.util.permission.check.SensorsTest;
import com.android.library.util.permission.check.SipTest;
import com.android.library.util.permission.check.SmsReadTest;
import com.android.library.util.permission.check.StorageReadTest;
import com.android.library.util.permission.check.StorageWriteTest;
