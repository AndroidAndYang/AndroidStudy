...
import com.android.library.util.permission.callback.Request;
import com.android.library.util.permission.callback.SettingService;
import com.android.library.util.permission.source.AppActivitySource;
import com.android.library.util.permission.source.ContextSource;
import com.android.library.util.permission.source.FragmentSource;
import com.android.library.util.permission.source.Source;
import com.android.library.util.permission.source.SupportFragmentSource;
...
public class PermissionUtil {
    ...
    {
        return new PermissionSettingImp(new AppActivitySource(activity));
    }
    ...
    {
        return new PermissionSettingImp(new SupportFragmentSource(fragment));
    }
    ...
    {
        return new PermissionSettingImp(new FragmentSource(fragment));
    }
    ...
    {
        return new PermissionSettingImp(new ContextSource(context));
    }
