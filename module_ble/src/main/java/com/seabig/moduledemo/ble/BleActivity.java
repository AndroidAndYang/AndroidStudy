...
import com.seabig.moduledemo.ble.adapter.BlueToothDeviceAdapter;
...
public class BleActivity extends BaseActivity implements View.OnClickListener {
    ...
    private void initView() {
        ...
        adapter = new BlueToothDeviceAdapter(getApplicationContext(), R.layout.ble_adapter_ble_detail);
    ...
    private final BroadcastReceiver mReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (BluetoothDevice.ACTION_FOUND.equals(action)) {
                ...
                Toast.makeText(BleActivity.this, "开始搜索", Toast.LENGTH_SHORT).show();
            } else if (BluetoothAdapter.ACTION_DISCOVERY_FINISHED.equals(action)) {
                Toast.makeText(BleActivity.this, "搜索完毕", Toast.LENGTH_SHORT).show();
            }
        }
    };
